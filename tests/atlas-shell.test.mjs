...
for (const lens of ['decisions', 'schema', 'logic', 'truth']) ok(`atlas nav offers ${lens} lens`, html.includes(`data-lens="${lens}"`));
...
ok('atlas lenses are 3 product + truth text', rail.includes('data-lens="decisions"') && rail.includes('data-lens="schema"') && rail.includes('data-lens="logic"') && rail.includes('data-lens="truth"') && !rail.includes('data-lens="components"') && !rail.includes('data-lens="ia"'));
