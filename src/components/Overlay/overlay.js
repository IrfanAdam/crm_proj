...
export function openOverlay(el, opts={}){
 const prev=document.activeElement; el.classList.add('overlay--open','drawer--open','tooltip--visible','toast--visible'); el.removeAttribute('hidden'); el.setAttribute('aria-hidden','false');
...
export function closeOverlay(el,prev){
 el.classList.remove('overlay--open','drawer--open','tooltip--visible','toast--visible'); el.setAttribute('hidden',''); el.setAttribute('aria-hidden','true');
