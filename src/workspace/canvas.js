...
function applyDevice(id){
 ...
 const bezelW=d.id==='pixel8'?8:10,bezelR=d.r+bezelW;
 ...
 if(island){
  if(d.id==='pixel8'){island.style.width='16px';island.style.height='16px';island.style.borderRadius='50%';island.style.left='50%';}
